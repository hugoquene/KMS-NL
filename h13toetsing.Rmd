...
T-Tests > One Sample T-Test (onder 'Classical)
```
Selecteer de variabele *score* en plaats deze in het veld "Variables". Zorg dat `Student` aangevinkt is onder "Tests" en houd `Test value:` op 0 staan. Vink onder "Additional Statistics" `Location parameter` aan en ook `Confidence interval`. Hier kun je zelf het betrouwbaarheidsniveau opgeven; hij staat standaard op 95%.  
