...
## Het one-shot single-case-ontwerp
...
## Het één-groep-voormeting-nameting-ontwerp
...
## Het nameting-controlegroep-ontwerp
...
```{r drakebenelheni2003fig2, echo=FALSE, fig.cap="Gemiddelde tijdsafstand tussen tikken (IOI, in ms) voor twee groepen luisteraars en twee muzieksoorten (ontleend aan Drake and Ben El Heni, 2003, Fig.2).", fig.align="center"}
