...
Quené, H. \& Van den Bergh, H. (2020). *Kwantitatieve Methoden en Statistiek*. 
Geraadpleegd op 28 sept 2020 via https://hugoquene.github.io/KMS-NL/ .

Quené, H. \& Van den Bergh, H. (2020). *Kwantitatieve Methoden en Statistiek* [in Dutch]. 
Retrieved 28 Sept 2020 from https://hugoquene.github.io/KMS-NL/ .
...
Andere versies van dit tekstboek (EPUB, PDF, HTML), de broncode (in Rmarkdown) van de tekst inclusief voorbeelden, bijbehorende databestanden, en de figuren als afzonderlijke bestanden, zijn alle beschikbaar via https://github.com/hugoquene/KMS-NL/ . 
