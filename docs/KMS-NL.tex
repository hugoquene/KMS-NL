...
\author{true}
\date{Versie gecompileerd op 25 Jan 2022}
...
\{\centering \includegraphics[width=22.61in]{figures/DBE12interaction}

\}

\textbackslash caption\{Gemiddelde begripsscores (met 95\%-betrouwbaarheidsintervallen), voor twee tekstversies en drie groepen lezers (naar Van Dooren, Van den Bergh en Evers-Vermeul, 2012).\}\label{fig:DBE12interaction}
...
Zwakke lezers presteren slechter dan gemiddelde lezers, bij de tekstversie zonder markeringen (p\textless.001), maar niet bij de versie met markeringen (p=.999). Sterke lezers presteren beter dan gemiddelde lezers, zowel zonder markeringen (p\textless.001) als met markeringen (p=.013). Tekstmarkeringen hebben wel effect bij zwakke lezers (p\textless.001) en bij gemiddelde lezers (p\textless.001) maar niet bij sterke lezers (p=.888); sterke lezers hebben dus geen baat bij structuurmarkeringen in de tekst, maar zwakke en gemiddelde lezers wel.
\end{quote}
...
Voor de versie zonder markeringen zien we dat de cel \texttt{zonder:zwak} lager scoort dan de cel \texttt{zonder:gemiddeld} (p\textless.001), en dat de cel \texttt{zonder:sterk} hoger scoort dan de cel \texttt{zonder:gemiddeld} (p\textless.001).
