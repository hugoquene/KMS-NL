...
\author{true}
\date{Versie gecompileerd op 21 Jan 2025}
...
dit tekstboek hanteren we de volgende definitie \citep[14]{KL00}:
...
`sterven'. In de woorden van \citep[51]{Popp63}:
...
gestandaardiseerd interview. We vinden echter dat de mannen meer lettergrepen gebruiken (gemiddeld 4210 lettergrepen) dan de vrouwen (gemiddeld 3926 lettergrepen) \citep[1112]{Quene08}.
Hoe
...
per seconde \citep[302]{Verh04}. We concluderen dat de hogere leeftijd de
...
staat bekend als \emph{randomisatie} \citep[294 ff]{SCC02}. We kunnen bijvoorbeeld
...
bekend is'' \citep[185, vert. HQ]{Pfung07}, of als het de persoon die de
...
\citep{Pfung07} \citep[38--47]{Watz77}.
\end{quote}
...
vergelijkbaar zijn \citep[266]{SCC02}: zijn Tunesische deelnemers die in
...
Als de werkelijke waarde in de populatie tussen deze grenzen ligt, dan is er een kans van 95\% om dit gemiddelde te vinden in een aselecte steekproef \citep[241]{Spie19}.
\end{quote}
...
physical, emotional and social welfare'' \citep[379]{Lata09}. De nieuwe
...
\citep[474]{Ferg89}. Stel dat we de gemiddelde score van een groep van
...
\citep[474]{Ferg89}. We hebben dus als het ware 10 proefpersonen verspeeld
...
of absence'' \citetext{\citealp[121]{Sagan96}; \citealp{Alde04}}. Het is daarom goed om ook altijd
...
nauwkeurigheid, in dit voorbeeld als \(p<.001\) \citep[zie ook][125]{Wright03}.
...
naarmate de steekproef groter wordt. Kort gezegd \citep[338, formule
11.10]{Rose08}:
\begin{equation}
  \label{eq:Rose08}
...
\citep[359, formule 12.1]{Rose08},
\[r = \sqrt{ \frac{t^2}{t^2+\textrm{df}} }\] en ten tweede de
standaardfout van de effectgrootte \(d\) \citep[600, formule 18]{Naka07}:
\begin{equation}
...
onderzoek \citep[118]{Schm96}. Anders gezegd: één goed ontworpen studie met
...
coefficients{]} are \emph{indispensable} parts of research results'' \citep[327, nadruk toegevoegd]{KL00}.
\end{quote}
...
``suggested by the data'' \citep[200]{MD04}. We moeten daarbij conservatief te
...
\begin{quote}
Bovendien verwachten de onderzoekers dat zwakke lezers de structuurmarkeringen meer nodig hebben, en dus meer baat erbij hebben, dan sterke lezers; ``sterke lezers zijn in staat studieteksten met begrip te lezen, ongeacht de aanwezigheid van structuurmarkeringen'' \citep[33]{DBE12}.
...
Het is echter inzichtelijker om het \emph{gestandardiseerde} residu van iedere cel te bepalen \citep[38]{Agre07}.
