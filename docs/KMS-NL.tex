...
\author{true}
\date{Versie gecompileerd op 27 Aug 2024}
...
Uit formule \eqref{eq:t-onesampleCI} volgt logischerwijze, dat als de
...
\end{equation}
(zie de overeenkomstige formule~\eqref{eq:t-onesampleCI}).
...
populatie, dan zou in 5\% van de herhaalde steekproeven de onbekende ware
effectgrootte in de populatie buiten het gevonden
betrouwbaarheidsinterval voor de effectgrootte vallen). Aangezien het
