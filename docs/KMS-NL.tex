...
Vink onder het kopje ``Assumption checks'' ook de optie \texttt{Normality} aan (§@ref(\#sec:ttoets-indep-aannames), derde assumptie, zie ook §\ref{sec:isvarnormaalverdeeld}) en eveneens \texttt{Equality\ of\ variances} (§@ref(\#sec:ttoets-indep-aannames), vierde assumptie).
