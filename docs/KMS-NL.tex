...
\author{true}
\date{Versie gecompileerd op 10 Mar 2021}
...
\item
  Alle observaties moeten onafhankelijk van elkaar zijn.
\item
  De scores moeten normaal verdeeld zijn in beide groepen (zie
...
De uitkomsten wijken enigszins af van die in Tabel \ref{tab:syldur2way-anova} omdat R de Sums of Squares op een iets andere wijze berekent\footnote{De berekeningswijze van R is na te bootsen in JASP met de keuze: Model, Sum of squares: Type I.}.
