...
\author{true}
\date{Versie gecompileerd op 14 Oct 2020}
...
populariteit).
Voor studenten en medewerkers van de Universiteit Utrecht zijn beide statistische pakketten geïnstalleerd in \texttt{MyWorkSpace}. SPSS is beschikbaar via \url{https://SurfSpot.nl} voor een sterk gereduceerde prijs. R is vrijelijk beschikbaar via \url{https://www.R-project.org}. Een korte inleiding in het gebruik van R is te vinden via \url{https://hugoquene.github.io/emlar2020/}.
