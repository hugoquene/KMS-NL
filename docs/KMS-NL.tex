...
\author{true}
\date{Versie gecompileerd op 20 Nov 2023}
...
In formules \eqref{eq:t-onesample} en \eqref{eq:t-pairedsamples} komt tot uiting dat de toetsingsgrootheid \(t\) groter wordt,
...
Als \(d\) ligt rond 1.2 dan spreken we van een zeer groot effect, en als \(d\) ligt rond 2.0 dan noemen we dat een `enorm' of `reusachtig' effect \citep[`huge',][]{Sawi09}.
...
\(r=.91\). Met deze gegevens vinden we \(\textrm{se}_d = 0.52\) via
