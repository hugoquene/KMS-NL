...
```{r kritiekeZwaarden-hulpfiguur, echo=FALSE}
...
appendixZ1[3,1] <- "Z*"
knitr::kable(
  appendixZ1, booktabs=TRUE, col.names=rep("",ncol(appendixZ1)), align="c" )
```
...
appendixZ2[3,1] <- "Z*"
knitr::kable(
  appendixZ2, booktabs=TRUE, col.names=rep("",ncol(appendixZ2)), align="c" )
```
