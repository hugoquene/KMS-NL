...
* **SPSS** (versie 22.0 en hoger): een populair pakket voor statistische analyses.    
SPSS is beschikbaar via <https://SurfSpot.nl> voor een sterk gereduceerde prijs. 

* **JASP** (versie 0.13 en hoger): een aantrekkelijk open-source pakket, met een gebruikersvriendelijke bediening, en met handige presentatie van resultaten.     
JASP is gratis beschikbaar via <https://jasp-stats.org/>. Op de website zijn ook inleidingen en instructies te vinden. 

* **R** (versie 3.0 en hoger): een wat moeilijker, maar ook krachtiger en veelzijdiger pakket, met snel stijgende populariteit bij onderzoekers.    
R is gratis beschikbaar via <https://www.R-project.org>. 
Een korte inleiding in het gebruik van R is te vinden via <https://hugoquene.github.io/emlar2020/>. 
Langere inleidingen zijn te vinden in @Dalg02 en in diverse uitstekende "free web books"; 
een lijst van aanbevolen materialen (Engelstalig) is te vinden op 
<https://statisticalhorizons.com/resources/free-r-resources>. 

Voor studenten en medewerkers van de Universiteit Utrecht zijn al deze statistische pakketten  geïnstalleerd in `MyWorkPlace`. 
