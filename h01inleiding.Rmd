...
populariteit). 
Voor studenten en medewerkers van de Universiteit Utrecht zijn beide statistische pakketten  geïnstalleerd in `MyWorkSpace`. 
SPSS is beschikbaar via <https://SurfSpot.nl> voor een sterk gereduceerde prijs. 
R is vrijelijk beschikbaar via <https://www.R-project.org>. 
Een korte inleiding in het gebruik van R is te vinden via <https://hugoquene.github.io/emlar2020/>. 
Langere inleidingen zijn te vinden bij de uitstekende "free web books" die je kunt vinden via <https://statisticalhorizons.com/resources/free-web-books-for-learning-r> en in @Dalg02. 
